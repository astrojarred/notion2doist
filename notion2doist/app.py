...
class syncManager:
    ...
    def __init__(self, todoist_token, notion_token, notion_settings_url):
        self.api = TodoistAPI(todoist_token, cache="/tmp/.todoist-sync/")
...
def compute_hmac(body):
    ...
    signature = base64.b64encode(hmac.new(
        os.environ.get("TODOIST_CLIENT_SECRET").encode('utf-8'),
        body,
...
def sync_notion():
    ...
    if request.args.get("full_sync") is not None:
